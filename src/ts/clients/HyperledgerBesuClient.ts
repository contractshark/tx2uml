...
export default class HyperledgerBesuClient extends EthereumNodeClient {
...
// Adds calls from a HyperledgerBesu debug_traceTransaction API response to the traces
const addTraces = (
